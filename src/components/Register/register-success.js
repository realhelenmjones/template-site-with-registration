  ...
  <>
    <Container>
        ...
        <p> Verify your E-Mail: Check you E-Mails (Spam folder
                  ...
                  <button
                  type="button"
                  onClick={userService.onSendEmailVerification}
                >
        ...
        <p>The SDA has just started up so at the moment there's not much to it. If the SDA begins to take off we'll become more interactive. Meanwhile please keep an eye on your email, keep coming back to this website or follow updates on the private facebook group .</p>
        
<p>Now you've joined the alliance have you got any thoughts about the following questions that need answering. If we start getting answers we'll create a forum or something to enable discussion.</p>
